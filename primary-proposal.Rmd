...
subtitle: "Primary Elections and Declining In-Party Warmth"
author: "Rob Lytle"
output:
  pdf_document:
#thanks: "The scaffolding for this project was laid last year as a purely descriptive work. Since then, almost every paragraph has (thankfully) been re-written and every figure recreated, recoded, or discarded in favor of something altogether new as the project's focus shifts towards causal identification and theory-building. Next Fall, I hope to be defending some further-evolved version of this document as my practicum, and from their&mdash;my dissertation. I've been very happy to have the opportunity to workshop and defend my arguments and analytical approach in class this semester, and look forward to hearing your feedback on this iteration of the document!"
...
In sum, descriptive data at both the macro and individual levels is consistent with our expectations given a causal relationship between primary election outcomes and individuals' partisan affect, but the data here cannot convincingly tell a causal story. To that end, I propose the following experiment. 
...
If primary election results affect intra-party affect, those who support winning candidates will be warmer towards their party, those who support losers will be colder.
...
First, participants' sincere party ID is solicited. Following @klar2017independent, a participant will be defined as a "partisan" if they indicate being registered with a party or *leaning* towards one party or the other. True independents will be excluded from the study.

Next, participants will be shown short vignettes of 10 policy positions of two counterfactual candidates, "Candidate A" and "Candidate B", running against each other in a congressional primary. 
    - The participants will not be informed that the candidates are counterfactual. 
    - The vignettes will be presented side-by-side, policy positions of each candidate will be randomized from a list of 20 neutrally worded positions.
        - Democratic and Republican positions will be drawn from different lists.
...
After reviewing the vignettes, the participant is asked which candidate they prefer. After making their choice, subjects in the treatment group are told the candidate lost the election, while subjects in the control group are presented with a brief loading screen.

Finally, each group is asked to rate their preferred party (whichever party the participant indicated a preference for at the beginning of the experiment) on the same 0-100 feeling thermometer scale.

After the second partisan rating, the participant is debriefed that the candidate and election were counterfactual, at which point the session concludes.
...
3. Preference for one of two congressional candidates in a primary election.
    - Participants will be shown short vignettes of policy details and political attributes of two candidates and asked to choose between them
...
I will use the standard $p<.05$ criteria to determine if the difference between treatment and control groups is statistically significant.
