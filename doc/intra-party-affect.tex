...
\begin{figure}[H]
\center\includegraphics[width=5in]{cdf-ridge-all-dis.png}
\caption{\label{fig:ridge-dis} \textit{\textbf{Ridgeline plot of partisan feeling thermometers.} Partisans' in-party/independents average FT. Plots show the distributions of mean partisan feeling thermometers---$(FT_D + FT_R)/2$---of those satisfied and dissatisfied with Democracy. Unsurprisingly, those dissatisfied are more likely to have a cold average FT}}
\end{figure}
