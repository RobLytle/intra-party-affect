...
\caption{\label{fig:cdf-below-med} \textit{\textbf{The proportion of partisans who whose in-party FT falls below the historical median (70).} Republicans and Democrats increasingly report feeling colder than the median. Republicans are particularly likely to }}
\end{figure}
